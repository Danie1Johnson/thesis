...
\begin{figure}[ht]
  %\includegraphics[scale=0.1, angle=0]{tetris.eps}
\caption{The relation between number of faces and intermediates in the Builging Game combinatorial configuration space.}
\label{fig:IntCount}
\end{figure}

\begin{figure}[ht]
  %\includegraphics[scale=0.1, angle=0]{tetris.eps}
\caption{The relation between number of faces and connections in the Builging Game combinatorial configuration space.}
\label{fig:IntCount}
\end{figure}

\begin{figure}[ht]
  %\includegraphics[scale=0.1, angle=0]{tetris.eps}
\caption{The relation between number of faces and paths in the Builging Game combinatorial configuration space.}
\label{fig:IntCount}
\end{figure}
