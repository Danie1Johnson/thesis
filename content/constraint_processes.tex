...
As mentioned in section~\ref{ssc:RemTrivDoF}, one way of fixing the translational degrees of freedom is to fix the center of mass of the configuration. While this method does not address the rotational degrees of freedom, it does appear to maintain the same distribution on the internal modes. This can bee seen in figures~\ref{fig:T2_4} and~\ref{fig:T3_5} which mirror figures~\ref{fig:T2_1} and ~\ref{fig:T3_1}.  Thus, we account for the rotational degrees of freedom separately.  
\begin{figure}[ht]
\centering
