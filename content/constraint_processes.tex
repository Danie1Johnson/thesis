...
\subsection{Cyclohexane Dynamics}\label{introduction}
...
\subsection{Analogy to Folding Model}
...
\subsection{MRBM on Building Game Geometric Configuration Spaces}
\subsubsection{Self-intersection Boundary}
\subsubsection{Fixing the Center of Mass}
\subsubsection{Fixing Rotations}
\subsubsection{BG Test Cases}
