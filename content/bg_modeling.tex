...
\end{itemize}
\end{mydef}
The act of attaching an additional face is refered to as a forward step in the building game and the removal of a face is a backward step. 
-- Language about forward and ckward connection directions?
